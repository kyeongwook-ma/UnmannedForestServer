...
public class AgentInstances
{
	...
	private static ArrayList<BaseAgent> iniList = new ArrayList<BaseAgent>();
	private static ArrayList<BaseAgent> tempList = new ArrayList<BaseAgent>();
	...
	public  static ArrayList<BaseAgent> getinitList()
	{	
		return iniList;
	}
	
	public  static ArrayList<BaseAgent> gettempList()
	{	
		return tempList;
	}
